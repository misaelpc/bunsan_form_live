defmodule BunsanFormLiveWeb.UserLiveTest do
  use BunsanFormLiveWeb.ConnCase

  import Phoenix.LiveViewTest

  alias BunsanFormLive.Accounts

  @create_attrs %{btc: "120.5", email: "some email", name: "some name", pin: "some pin", usd: "120.5"}
